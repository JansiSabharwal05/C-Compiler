...
#line 1671 "parser1.tab.c"
    break;

  case 98: /* $@17: %empty  */
#line 257 "parser1.y"
                                                               {push("+=");}
#line 1677 "parser1.tab.c"
    break;
...
#line 1689 "parser1.tab.c"
    break;

  case 100: /* $@18: %empty  */
#line 264 "parser1.y"
                                                                  {push("-=");}
#line 1695 "parser1.tab.c"
    break;
...
#line 1707 "parser1.tab.c"
    break;

  case 102: /* $@19: %empty  */
#line 271 "parser1.y"
                                                                     {push("*=");}
#line 1713 "parser1.tab.c"
    break;
...
#line 1790 "parser1.tab.c"
    break;

  case 113: /* simple_expression: and_expression  */
#line 298 "parser1.y"
                                         {if(yyvsp[0] == 1) yyval=1; else yyval=-1;}
#line 1796 "parser1.tab.c"
    break;

  case 114: /* @23: %empty  */
#line 301 "parser1.y"
                                                      {push("&&");}
#line 1802 "parser1.tab.c"
    break;
...
#line 302 "parser1.y"
                                                     {if(yyvsp[0] == 1) yyval=1; else yyval=-1;}
#line 1814 "parser1.tab.c"
    break;

  case 117: /* @24: %empty  */
#line 306 "parser1.y"
                                               {push("!");}
#line 1820 "parser1.tab.c"
    break;
...
#line 332 "parser1.y"
                                    {if(yyvsp[0] == 1) yyval=1; else yyval=-1;}
#line 1940 "parser1.tab.c"
    break;

  case 138: /* factor: mutable  */
#line 333 "parser1.y"
                                  {if(yyvsp[0] == 1) yyval=1; else yyval=-1;}
#line 1946 "parser1.tab.c"
    break;
...
#line 1964 "parser1.tab.c"
    break;

  case 140: /* $@25: %empty  */
#line 349 "parser1.y"
                                           {if(!checkscope(curid)){printf("%s\n",curid);printf("Undeclared\n");exit(0);}}
#line 1970 "parser1.tab.c"
    break;
